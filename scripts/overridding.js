...
Tornado.prototype.toString = function(){
  ...
  return "This tornado has been classified as " + this.category + ", with wind gusts up to " + this.windGust + "mph. Affected areas are: " + list + ", potentially affecting a population of " + this.valueOf() + ".";
};

Object.prototype.findOwnerOfProperty = function(propName){
  var currentObject = this; // start off looking for the prop with the caller Object itself
